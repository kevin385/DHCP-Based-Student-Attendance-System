        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <span id="error_student_subject_id" class="text-danger"></span>
              </div>
            </div>
          </div>
        </div>
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				if(data.error)
				{
					...
					if(data.error_student_subject_id != '')
					{
						$('#error_student_subject_id').text(data.error_student_subject_id);
					}
					else
					{
						$('#error_student_subject_id').text('');
