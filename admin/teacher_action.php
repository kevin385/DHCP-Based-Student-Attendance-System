...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		ON tbl_subject.subject_id = tbl_teacher.teacher_subject_id 
		";
	...
	if($_POST["action"] == 'Add' || $_POST["action"] == "Edit")
	{
		...
		{
			$error_teacher_subject_id = "Subject is required";
			$error++;
		}
		else
		{
		...
		else
		{
			if($_POST["action"] == 'Add')
			{
				...
				(teacher_name, teacher_address, teacher_emailid, teacher_password, teacher_qualification, teacher_doj, teacher_image, teacher_subject_id) 
				SELECT * FROM (SELECT :teacher_name, :teacher_address, :teacher_emailid, :teacher_password, :teacher_qualification, :teacher_doj, :teacher_image, :teacher_subject_id) as temp 
				WHERE NOT EXISTS (
	...
	if($_POST["action"] == "edit_fetch")
	{
		...
		if($statement->execute())
		{
			...
			foreach($result as $row)
			{
				...
				$output["teacher_subject_id"] = $row["teacher_subject_id"];
