...
if(isset($_GET["action"]))
{
	...
	{
		if(isset($_GET["subject_id"], $_GET["from_date"], $_GET["to_date"]))
		{
			$pdf = new Pdf();
			$query = "
			...
			WHERE tbl_student.student_subject_id = '".$_GET["subject_id"]."' 
			...
			foreach($result as $row)
			{
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="0">
			        ...
			        <tr>
			            ...
			            <td width="75%">'.$row["subject_name"].'</td>
			        </tr>
			        <tr>
